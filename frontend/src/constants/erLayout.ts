...
export const ER_NODE_POSITIONS: Record<string, ERNodePosition> = {
  ...
  subscriptions: { x: 40, y: 250, w: 200, h: 140 },
  orders: { x: 280, y: 250, w: 200, h: 150 },
  invoices: { x: 520, y: 250, w: 200, h: 130 },
  sessions: { x: 760, y: 250, w: 200, h: 120 },
  payments: { x: 280, y: 440, w: 200, h: 120 },
};
...
export const ER_RELATIONSHIPS: ERRelationship[] = [
  ...
  { from: 'users', to: 'invoices', label: '1 : N (CASCADE)', fk: 'user_id ➔ users.id' },
